...
public class CodeReview {
	...
	public CodeReview(Long cR_NO, String cR_TITLE, String cR_CREATER, String cR_CONTENTS, String cR_CREATEDAY,
	...
	public String getCR_CREATER() {
		return CR_CREATER;
	}
	public void setCR_CREATER(String cR_CREATER) {
		CR_CREATER = cR_CREATER;
	}
