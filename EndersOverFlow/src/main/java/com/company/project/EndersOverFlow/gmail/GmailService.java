...
public class GmailService {
    ...
    private static final String CREDENTIALS_FILE_PATH = "/com/company/project/EndersOverFlow/gmail/credentials.json";
    ...
    public static void mainService() throws IOException, GeneralSecurityException {
